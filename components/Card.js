...
export function Card () {
  return (
    <Link href='/panel/id'>
        <a className="block p-6 max-w-sm bg-white rounded-lg border border-gray-300 shadow-md hover:bg-slate-50  m-auto transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-300 animate-fade-in-up">
            ...
            <div className="pt-4">
                <div className="w-full bg-gray-200 rounded-full ">
                    <div className="bg-blue-700 text-xs font-medium text-blue-100 text-center p-0.5 leading-none rounded-full w-1/2"> 50%</div>
                </div>
            </div>
            <div className="mt-4">
