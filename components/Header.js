      ...
      <nav className=" border-gray-200 py-2.5 bg-black">
        <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
          ...
          <div className="flex items-center lg:order-2">
            ...
            <Link href="/panel">
              <a
                className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Panel</a>
            </Link>
