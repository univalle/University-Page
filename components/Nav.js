...
export function Nav () {
  return (
        <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-800 w-2/4">
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                <a href="https://flowbite.com/" className="flex items-center">
                    <img
                        src="https://surdle.github.io/univalle/logo.png"
                        alt="Picture of the author"
                        className="mr-3 h-6 sm:h-9"
                    />
                    <span className="self-center text-xl font-bold whitespace-nowrap dark:text-gray-200">Univalle</span>
                </a>
